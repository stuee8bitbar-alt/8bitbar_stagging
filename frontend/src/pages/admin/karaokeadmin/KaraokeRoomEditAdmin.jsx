...
const KaraokeRoomEditAdmin = () => {
  ...
  // Remove weekDaysArr and timeSlotsArr state
  ...
  // Add state and handlers for booking block UI at the top of the component
  ...
  const handleAddBlock = () => {
    ...
    // This function is no longer needed as blocks are managed by state
    // setBookingBlocks([
    //   ...bookingBlocks,
    //   {
  ...
  const handleDeleteBlock = (idx) => {
    // This function is no longer needed as blocks are managed by state
    // setBookingBlocks(bookingBlocks.filter((_, i) => i !== idx));
  };
  const handleEditBlock = (idx) => {
    // This function is no longer needed as blocks are managed by state
    // const block = bookingBlocks[idx];
    // setBlockStartDate(block.start);
    // setBlockEndDate(block.end);
      ...
      <form onSubmit={handleSubmit}>
        <div className="bg-white shadow-lg sm:rounded-xl md:w-full">
          ...
          <div className="px-4">
            ...
            {/* ... Main Image and ImagesInput as before ... */}
            <div className="sm:col-span-6">
              <FormInput
          ...
          {/* --- BOOKING BLOCK SECTION (move to end, fix spacing) --- */}
          <div className="mt-10 px-4">
            <h3 className="text-lg font-medium leading-6 text-gray-900">Booking Block</h3>
            <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
              <div className="sm:col-span-3">
